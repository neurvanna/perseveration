classdef agent_bayes_drifts_habits
    ...
    methods
        %% Constructor
        function self = agent_bayes_drifts_habits(params, resolution)
        ...
        function params = get_params(self)
           params = [self.beta, self.sigma, self.alpha_habit, self.beta_habit]; 
        end
        ...
        function agent_state = get_agent_state(self)
            %agent_state = [self.pPl; self.pPr; self.H];
            agent_state = [self.pPl, self.pPr, self.H];
        end
