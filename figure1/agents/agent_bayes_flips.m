classdef agent_bayes_flips
    ...
    methods
        %% Constructor
        function self = agent_bayes_flips(params)
            if ~exist('params', 'var')
        ...
        function params = get_params(self)
           params = [self.reward_prob_low, self.reward_prob_high, self.flip_prob, self.beta]; 
        end
